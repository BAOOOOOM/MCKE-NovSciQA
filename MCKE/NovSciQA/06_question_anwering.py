...
with open(data_path,"r") as f:
    ...
    for id in data:
        ...
        prompt2="Question: "+question+"\n"
        prompt3="Options: "+option+"\n"
        prompt4="Rationale: "+new_pred_solution+"\n"
        ...
        current_item={"question":question,"choices":choices,"answer":answer,"subject":subject,"category":category,"human_skill":skill,"pred_solution":new_pred_solution,"pred_answer":llama_answer,"human_lecture":lecture,"human_solution":solution,"llama_is_true":llama_is_true,"selected_example":example,"split":split}
